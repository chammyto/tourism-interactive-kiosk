         ...
         <!--   <div class="col-md-12">
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card mb-4" style="background-color: rgba(0, 0, 0, .7);box-shadow: 0 4px 8px 0 rgba(225, 225, 225, 0.2), 0 6px 20px 0 rgba(225, 225, 225, 0.7);">
                        <a href="{{ url('destinations?category='.$category->id) }}"> <img src="{{ Storage::url($category->image) }}  "  class="card-img-top" height="150"> </a>
                          <div class="card-body">
                           ...
                           <!-- <p class="card-text">{{ $category->description }}</p> -->
                            <a href="{{ url('destinations?category='.$category->id) }}" class="btn btn-success" style=" box-shadow: 0 3px 6px 0 rgba(225, 225, 225, 0.2), 0 5px 10px 0 rgba(225, 225, 225, 0.7);">Let's go....!</a>
                          </div>
                        </div>
                    </div>
                    @endforeach
